...
--    ContestID x
    ...
    CreditSubmitted lst -> "<CREDIT_SUBMITTED" ++ renderString (intercalate "," (map show lst))
    CreditGranted lst   -> "<CREDIT_GRANTED" ++ renderString (intercalate "," (map show lst))
 ...
 where
    ...
    renderBoolean b | b = "Y" | otherwise = "N"
